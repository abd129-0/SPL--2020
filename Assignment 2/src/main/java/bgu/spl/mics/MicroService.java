...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> MC = new ConcurrentHashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        if (MC.get(type) == null)//if it was not added before
            MC.put(type, callback);
    }
 ...
 qs    * micro-service processing this event.
    ...
    public final void run() {
        ...
        while (!terminate) {
            try {
                ...
                Callback callback = MC.get(message.getClass());
