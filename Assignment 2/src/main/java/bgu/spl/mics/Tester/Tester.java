...
public class Tester {
    ...
    */
    ...
    public void runTestsFromFile() {
        ...
        int failedTests = 0;
        Test currentTests[];
        Diary diaryInstance = Diary.getDiaryInstance();
        try {
            currentTests = getTestsFromJson("/home/spl211/IdeaProjects/SPL211/src/main/java/Tests.json");
            for (int i = 0; i < currentTests.length; i++) {
                ...
                String[] str = {"/home/spl211/IdeaProjects/SPL211/input.json","/home/spl211/IdeaProjects/SPL211/Output.json"};
                Main.main(str);
                do {
                    Thread.sleep(10);
